...
# Sprint R02: registro tardio do Blueprint de Compras.
# O registro ocorre ao final do arquivo para permitir injeção segura das funções
# auxiliares que ainda permanecem no app.py durante a refatoração gradual.
from routes.compras_routes import create_compras_blueprint

app.register_blueprint(create_compras_blueprint({
    "criar_tabelas": criar_tabelas,
    "conectar_banco": conectar_banco,
    "erp_garantir_conta_pagar_compra": erp_garantir_conta_pagar_compra,
    "erp_sincronizar_compras_estoque_financeiro": erp_sincronizar_compras_estoque_financeiro,
    "recalcular_receitas_salvas": recalcular_receitas_salvas,
    "resumo_financeiro": resumo_financeiro,
    "_erp_garantir_tabelas_base": _erp_garantir_tabelas_base,
    "_erp_recalcular_cmv_todos": _erp_recalcular_cmv_todos,
    "_erp_registrar_evento": _erp_registrar_evento,
    "_erp_auditoria_geral": _erp_auditoria_geral,
}))
